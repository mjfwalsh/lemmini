...
public class Stencil {
  ...
  public static final int MSK_STEEL = 2;

  /** Lemmings can either walk on steel or on brick */
  public static final int MSK_WALK_ON = MSK_BRICK | MSK_STEEL;

  /**
   * stair build by a builder - note that this is just an additional attribute - brick is also
   * needed to walk on it
   */
  public static final int MSK_STAIR = 4;

  /** right side of stopper mask - reflects to the right */
  public static final int MSK_STOPPER_RIGHT = 8;

  /** left side of stopper mask - reflects to the left */
  public static final int MSK_STOPPER_LEFT = 16;

  /** stopper mask (either left or right) */
  public static final int MSK_STOPPER = MSK_STOPPER_RIGHT | MSK_STOPPER_LEFT;

  /** arrow to the right - no digging to the left */
  public static final int MSK_NO_DIG_LEFT = 32;

  /** arrow to the left - no digging to the right */
  public static final int MSK_NO_DIG_RIGHT = 64;
  ...
  public static final int MSK_TRAP_REPLACE = 256;

  /** a trap that triggers the normal death animation */
  public static final int MSK_TRAP_DIE = 512;

  /** a trap (either DROWN, REPLACE or DIE) */
  public static final int MSK_TRAP = MSK_TRAP_DROWN | MSK_TRAP_REPLACE | MSK_TRAP_DIE;

  /** the level exit */
  public static final int MSK_EXIT = 1024;

  /** number of bits the identifier is shifter up (below is the bitmask part) */
  private static final int ID_SHIFT_VAL = 16;
  ...
  public void clear() {
    ...
    for (int idx = 0; idx < size; idx++) stencil[idx] = MSK_EMPTY;
  }
